...
BatBehavior::BatBehavior() : Component(L"BatBehavior")
{
...
void BatBehavior::Serialize(std::wfstream& InputStream)
{
}
...
void BatBehavior::HandleEvent(Event* pEvent)
{
