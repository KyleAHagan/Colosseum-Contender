...
RatBehavior::RatBehavior() : Component(L"RatBehavior")
{

}

RatBehavior::~RatBehavior()
{

}

void RatBehavior::Serialize(std::wfstream& InputStream)
{
}

void RatBehavior::Update()
{
...
void RatBehavior::HandleEvent(Event* pEvent)
{
