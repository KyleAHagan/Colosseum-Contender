...
GoblinMeleeBehavior::GoblinMeleeBehavior() : Component(L"GoblinMeleeBehavior")
{

}

GoblinMeleeBehavior::~GoblinMeleeBehavior()
{

}

void GoblinMeleeBehavior::Serialize(std::wfstream& InputStream)
{
}

void GoblinMeleeBehavior::Update()
{
...
void GoblinMeleeBehavior::HandleEvent(Event* pEvent)
{
