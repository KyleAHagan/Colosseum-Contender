...
SpiderBehavior::SpiderBehavior() : Component(L"SpiderBehavior")
{

}

SpiderBehavior::~SpiderBehavior()
{

}

void SpiderBehavior::Serialize(std::wfstream& InputStream)
{
}

void SpiderBehavior::Update()
{
...
void SpiderBehavior::HandleEvent(Event* pEvent)
{
