...
TrollBehavior::TrollBehavior() : Component(L"TrollBehavior")
{

}

TrollBehavior::~TrollBehavior()
{

}

void TrollBehavior::Serialize(std::wfstream& InputStream)
{
}

void TrollBehavior::Update()
{
...
void TrollBehavior::HandleEvent(Event* pEvent)
{
