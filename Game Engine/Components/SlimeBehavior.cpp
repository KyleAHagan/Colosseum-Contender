...
SlimeBehavior::SlimeBehavior() : Component(L"SlimeBehavior")
{
...
void SlimeBehavior::Serialize(std::wfstream& InputStream)
{
}

void SlimeBehavior::Update()
{
...
void SlimeBehavior::HandleEvent(Event* pEvent)
{
